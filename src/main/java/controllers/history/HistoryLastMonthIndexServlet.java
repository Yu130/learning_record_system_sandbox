...
/**
 * Servlet implementation class LastMonthIndex
 */
@WebServlet("/history/lastMonthIndex")
public class HistoryLastMonthIndexServlet extends HttpServlet {
    private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public HistoryLastMonthIndexServlet() {
        super();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        YearMonth last_ym = current_ym.minus(1, ChronoUnit.MONTHS);
        String ym = last_ym.toString();
        ...
        int year = last_ym.getYear();
        int month = last_ym.getMonthValue();

        request.getSession().setAttribute("current_ym", last_ym);
